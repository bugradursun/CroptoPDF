...
alici_adres1 = " ".join(adress_parts1[:3])
alici_adres2= " ".join(adress_parts1[3:])
...
veriler1= {
    ...
    "alici_adres2":alici_adres2,"alici_adi1":alici_adi1,"alici_adi2":alici_adi2,"alici_adi11":alici_adi11,"alici_adi22":alici_adi22,
}